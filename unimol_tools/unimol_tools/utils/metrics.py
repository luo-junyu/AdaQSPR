...
from unimol_tools.utils.base_logger import logger
...
METRICS_REGISTER = {
    'regression': {
        ...
        "rmse": [rmse_score, False, 'float'],
        "rrmse": [rrmse_score, False, 'float'],
...
DEFAULT_METRICS = {
    'regression': ['mse', 'rmse', 'rrmse', 'mae', 'r2', 'spearmanr', 'pearsonr'],
